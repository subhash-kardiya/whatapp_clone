        ...
        <aside class="app-sidebar-nav">
            <div class="nav-top">
                ...
                <a href="{{ route('chat') }}" class="nav-item nav-chat-item {{ Route::is('chat') ? 'active' : '' }}" 
                   @click="if (window.chatAppInstance) { $event.preventDefault(); window.chatAppInstance.setLeftPanel('chats'); }" title="Chats">
                ...
                <!-- Channels -->
                <a href="#" class="nav-item" @click.prevent="if (window.chatAppInstance) { window.chatAppInstance.setLeftPanel('channels'); }" title="Channels">
                    <svg viewBox="0 0 24 24" fill="currentColor" class="nav-svg">
                ...
                <!-- Communities -->
                <a href="#" class="nav-item" @click.prevent="if (window.chatAppInstance) { window.chatAppInstance.setLeftPanel('communities'); }" title="Communities">
                    <svg viewBox="0 0 24 24" fill="currentColor" class="nav-svg">
                ...
                <a href="#" class="nav-item nav-settings-item" @click.prevent="if (window.chatAppInstance) { window.chatAppInstance.setLeftPanel('settings'); }" title="Settings">
                    <svg viewBox="0 0 24 24" fill="currentColor" class="nav-svg">
            ...
            <div class="nav-bottom">
                ...
                <a href="{{ route('profile') }}" class="nav-item nav-profile-avatar-item {{ Route::is('profile') ? 'active' : '' }}" 
                   @click="if (window.chatAppInstance) { $event.preventDefault(); window.chatAppInstance.setLeftPanel('profile'); }" title="Profile">
